...
var validator = form.validate({
    ...
    messages: {
        ...
        id_doc: {
          required: 'Pilih gambar KTP/SIM/Paspor',
...
form.children("div").steps({
    ...
    onStepChanging: function (event, currentIndex, newIndex) {
        ...
        if (newIndex == 2 && $('#steps-uid-0-p-2').attr('style') == "display: block; left: 0px;"){
        ...
        if ( $('#steps-uid-0-p-2').attr('style') == "display: block; left: 0px;" ) {

...
class Handler extends ExceptionHandler
{
    ...
    {
        if ($exception instanceof \App\Exceptions\TokenNotFoundException) {
            return redirect('/verify/resend')->with('error','Kode verifikasi tidak ditemukan, silahkan mengirim ulang kembali');

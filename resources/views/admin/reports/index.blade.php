<div class="box box-default">
    ...
    <!-- /.box-header -->
    <div class="box-body">
        <h4>Loan ID: {{$loan->id}}, Tenor: {{$loan->tenor->month}} month</h4>
        ...
        <div class="table-responsive">
            <table class="table table-striped">
                ...
                <tbody>
                    @if($loan->tenor->grades()->where('rank','A')->first())
                    <!-- A -->
                    <tr>
                    ...
                    @endif
                    @if($loan->tenor->grades()->where('rank','B')->first())
                    <!-- B -->
                    <tr>
                    ...
                    @endif
                    @if($loan->tenor->grades()->where('rank','C')->first())
                    <!-- C -->
                    <tr>
                    ...
                    @endif
                    @if($loan->tenor->grades()->where('rank','D')->first())
                    <!-- D -->
                    <tr>
                        <td colspan="5"><b>D</b></td>
                    </tr>
                    <tr>
                        <td>BI Checking lower than Collect 2 (Collect 3, Collect 4, Collect 5)</td>
                        <td>-</td>
                        <td>-</td>
                        <td>-</td>
                        <td>@if (($user->bi_checking) && ($user->bi_checking > 2)) <i class="fa fa-check"></i> @else <i class="fa fa-times"></i> @endif</td>
                    ...
                    <tr>
                        <td>Doesn't Works in Affiliate Company</td>
                        <td>-</td>
                        <td>-</td>
                        <td>-</td>
                        <td>@if (!$user->worksInAffiliateCompany) <i class="fa fa-check"></i> @else <i class="fa fa-times"></i> @endif</td>

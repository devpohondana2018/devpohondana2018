...
<!--             <tr>
            ...
            <tr>
                <td bgcolor="#ffffff" style="padding: 20px 40px 40px; text-align: left;">
                    <h1 style="margin: 0; font-family: sans-serif; font-size: 16px; line-height: 125%; color: #333333; font-weight: bold;">Yang Terhormat Bapak/Ibu <span> {{ucwords($loan->user->name)}}<span></h1>
                </td>
            </tr>
            <tr>
                <td bgcolor="#ffffff" style="padding: 0 40px 20px; font-family: sans-serif; font-size: 15px; line-height: 140%; color: #555555; text-align: center; font-weight: bold;">
                    <p style="margin: 0px 0px 15px 0px;">Anda telah menolak pinjaman yang telah disetujui oleh Pohon Dana.</p>
                </td>
            </tr>

            <tr>
                <td bgcolor="#ffffff" style="padding: 0 40px 10px; font-family: sans-serif; font-size: 15px; line-height: 140%; color: #555555; text-align: left; font-style: italic;">
                    <p style="margin: 0px 0px 15px 0px;">Terima kasih telah mengajukan pinjaman pada situs POHON DANA, kami akan melayani Anda pada pengajuan berikutnya.</p>
                </td>
            </tr>
            <tr>

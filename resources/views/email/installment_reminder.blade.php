    ...
    <table role="presentation" cellspacing="0" cellpadding="0" border="0" align="center" width="600" style="margin: auto;" class="email-container">
            ...
            <tr>
                <td bgcolor="#ffffff" style="padding: 15px 40px 15px; font-family: sans-serif; font-size: 15px; line-height: 140%; color: #555555; text-align: center; font-weight: bold;">
                    <p style="margin: 20px 20px 20px 0px;">Anda mempunyai tagihan cicilan yang harus dibayarkan untuk pinjaman Anda.</p>
                </td>
            </tr>
            ...
            <tr>
                <td bgcolor="#ffffff" style="padding: 0 40px 10px; font-family: sans-serif; font-size: 15px; line-height: 140%; color: #555555; text-align: left;">
                    <p style="margin: 0px 0px 15px 0px;">Informasi cara melakukan pembayaran bisa Anda lihat di pinjaman Anda melalui situs POHON DANA atau dengan klik link dibawah ini.</p>
                </td>
            </tr>
            <tr>

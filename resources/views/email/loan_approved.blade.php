...
<!--             <tr>
            ...
            <tr>
                <td bgcolor="#ffffff" style="padding: 15px 40px 15px; font-family: sans-serif; font-size: 15px; line-height: 140%; color: #555555; text-align: center; font-weight: bold;">
                    <p style="margin: 20px 20px 20px 0px;">SELAMAT, pengajuan pinjaman Anda telah disetujui.</p>
                </td>
            </tr>
            ...
            <tr>
                <td bgcolor="#ffffff" style="padding: 0 40px 10px; font-family: sans-serif; font-size: 15px; line-height: 140%; color: #555555; text-align: left;">
                    <p style="margin: 0px 0px 15px 0px;">Silakan melakukan konfirmasi pinjaman dan melengkapi nomor rekening tujuan pencairan pada link dibawah ini atau Anda dapat masuk ke situs POHON DANA.</p>
                </td>
            </tr>
            <tr>
                        ...
                        <tr>
                            <td style="border-radius: 3px; background: #222222; text-align: center;" class="button-td">
                                <a href="{{ url('member/loans/'.$loan->id) }}" style="background: #222222; border: 15px solid #222222; font-family: sans-serif; font-size: 13px; line-height: 110%; text-align: center; text-decoration: none; display: block; border-radius: 3px; font-weight: bold;" class="button-a">
                                    &nbsp;&nbsp;&nbsp;&nbsp;<span style="color:#ffffff;">Konfirmasi Pinjaman</span>&nbsp;&nbsp;&nbsp;&nbsp;
                                </a>
                            </td>
                        </tr>
                    </table>

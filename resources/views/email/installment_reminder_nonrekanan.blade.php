    ...
    <table role="presentation" cellspacing="0" cellpadding="0" border="0" align="center" width="600" style="margin: auto;" class="email-container">
            ...
            <tr>
                <td bgcolor="#ffffff" style="padding: 0 40px 10px; margin-top: 10px; font-family: sans-serif; font-size: 15px; line-height: 140%; color: #555555; text-align: left;">
                    ...
                    @endphp
                    <p style="margin: 0px 0px 15px 0px;">Jumlah Angsuran Pinjaman Anda yang akan jatuh tempo pada tanggal {{ $fullDate }} adalah sebesar Rp. {{ number_format($installment->amount, 0, '.', '.') }}, Mohon lakukan pembayaran.</p>
                    <p>Untuk pembayaran angsuran pinjaman, dapat ditujukan ke :</p>
                    <p>
                        <table width="100%">
                            <tr>
                                <td width="40%">Nama Pemilik Rekening</td>
                                <td width="5%">:</td>
                                <td width="55%">PT. Pohon Dana Indonesia</td>
                            </tr>
                            @if($midtrans->isProduction())
                                <tr>
                                    <td>BCA Virtual Account</td>
                                    <td>:</td>
                                    <td>{{ $userVa->va_number }}</td>
                                </tr>
                                <tr>
                                    <td>Bank</td>
                                    <td>:</td>
                    ...
                    <p>
                        Abaikan pesan ini apabila Anda sudah membayar
                    </p>
                    <p>
                        Klik pada link dibawah ini untuk mengetahui detail jumlah dan tanggal jatuh tempo angsuran.
                    </p>
                </td>
            </tr>
            <tr>

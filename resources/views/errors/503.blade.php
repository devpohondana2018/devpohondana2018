...
<head>
    ...
    <!-- Document Title
        ============================================= -->
        <title>Pohon Dana | Maintenance</title>
        <!-- Style Canvas -->
                            ...
                            <div class="swiper-slide dark" style="background-image: url('{{ asset('images/pohondana/slider-home.jpg') }}');">
                                <div class="container clearfix">
                                    <div class="slider-caption slider-caption-center slider-caption-home">
                                        ...
                                        <h2 data-caption-animate="fadeInUp">SEDANG DALAM PERBAIKAN</h2>
                                        <p data-caption-animate="fadeInUp" data-caption-delay="200" style="margin-bottom: 25px;">Pohon Dana saat ini sedang melakukan maintenance. <br> Selama masa maintenance, silahkan menghubungi kami melalui:<br/>
                                        Telephone : 021. 5229660<br>
                                        Whatsapp : 081.11829660<br>
                                        E-mail : customerservice@pohondana.id</p>
                                    </div>

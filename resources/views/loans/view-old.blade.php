...
<div class="container">
    ...
    <div class="row">
              ...
              <div class="card-body">
                  ...
                  <div class="card-body-detail">
                      ...
                      <div class="row nopadding">
                          ...
                          <div class="col-md-6">
                              <dd>{{round(($loan->amount_funded/$loan->amount_requested)*100,2)}}%</dd>
                          </div>
                      </div>
        ...
        <div class="col-md-6">
          @if($loan->status_id == '2' || $loan->status_id == '3')
                ...
                <div class="card-body">
                  <div class="pending-payment">
                    ...
                    @else
                      ...
                      An: PT pohon dana indonesia
                      <div class="due-date">Jatuh Tempo :
                        {{ \Carbon\Carbon::createFromTimestamp($currentPendingInstallment['due_date'])->format('d/m/Y') }}
                      </div>
                ...
                <div class="card-body">
                  ...
                  <tbody>
                      ...
                      <tr>
                          ...
                          <td><span class="badge badge-{{$installment->paid == 1 ? 'success' : 'secondary'}}">{{strtoupper($installment->paid == 1 ? 'paid' : 'unpaid')}}</span></td>
                      </tr>
                      @endforeach
                  </tbody>
                  </table>
...
@section('javascript')
    ...
    <script>
      ...
      setEvent = () => {
          $(comp.imagePaymentPicker).click(function(e) { onImagePaymentClick(e, this) });
          $(comp.inputImagePayment).change(function(e) { onInputImagePaymentChange(e, this) });
          $(comp.imagePaymentPreviewDiv).click(function(e) { onImagePaymentClick(e, this) });
          $(comp.btnActionApprove).click(function(e) { onActionClick(e, this) });
          $(comp.btnActionDecline).click(function(e) { onActionClick(e, this) });

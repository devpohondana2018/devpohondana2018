...
<title>Pohon Dana | Pengajuan Pinjaman</title>
<!-- Style Canvas -->
...
<!-- #wrapper end -->
    ...
    <!-- Footer Scripts
      ...
      <script type="text/javascript" src="{{ asset('js/pohondana/inputmask.js')}}"></script>
      ...
      <script type="text/javascript" src="{{ asset('js/pohondana/register-borrow-company.js')}}?ver=1.{{ date('d.i.s') }}"></script>

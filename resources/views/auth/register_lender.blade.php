                            ...
                            <div>
                                ...
                                <section>
                                    ...
                                    <div class="form-group row">
                                        <label for="name" class="col-md-4 col-form-label label-form text-md-right">Nama *</label>
                                        <div class="col-md-6">
                                ...
                                <section>
                                    ...
                                    <div class="form-group row">
                                        <label for="id_no" class="col-md-4 col-form-label label-form text-md-right">No. KTP/SIM/Paspor *</label>
                                        <div class="col-md-6">
                                    ...
                                    <div class="form-group row">
                                        <label for="id_doc" class="col-md-4 col-form-label label-form text-md-right">Upload KTP/SIM/Paspor *</label>
                                        <div class="col-md-6">
                                    ...
                                    <div class="form-group row hidden">
                                        <label for="id_doc_base_64" class="col-md-4 col-form-label label-form text-md-right">Upload KTP/SIM/Paspor *</label>
                                        <div class="col-md-6">
                                    ...
                                    <div class="form-group row hidden">
                                        <label for="npwp_doc_base_64" class="col-md-4 col-form-label label-form text-md-right">Upload NPWP *</label>
                                        <div class="col-md-6">
                                    ...
                                    <div class="form-group row">
                                        <label for="home_city" class="col-md-4 col-form-label label-form text-md-right">Kota/Kabupaten *</label>
                                        <div class="col-md-6">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            @if ($errors->has('pob'))
                                            <label id="pob-error" class="error help-block" for="pob">
                                                {{ $errors->first('pob') }}
                                            </label>
                                            @endif
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            @if ($errors->has('dob'))
                                            <label id="dob-error" class="error help-block" for="dob">
                                                {{ $errors->first('dob') }}
                                            </label>
                                            @endif
                                        </div>
...
@section('javascript')
    <!-- <script src="//cdn.jsdelivr.net/npm/jquery-validation@1.17.0/dist/jquery.validate.min.js"></script>
        ...
        <script src="{{ asset('js/pohondana/register_lender.js') }}"></script>
        @endsection
